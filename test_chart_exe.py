...
from test_chart import Piechart,Barchart,Linechart,Scatterchart
...
class MAIN_menu(QMainWindow):
	def __init__(self):
		...
		self.donut_chart = Scatterchart()
		
		self.chart_timer = QTimer()
		self.chart_timer.timeout.connect(self.update_chart)
		self.chart_timer.start(6000)
		...
		self.lcd_1.display(1010)
		self.lcd_2.display(87897)
		self.lcd_3.display("96:69")
	...
	def update_chart(self):
		print("updating")
		self.donut_chart.chart.removeAllSeries()
		self.donut_chart.update_data()
		self.donut_chart.chart.addSeries(self.donut_chart.series)
